...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        {
            if (await _userManager.FindByEmailAsync("joyanta.uk@gmail.com")  == null)
            {
                var user = new WorldUser()
                {
                    UserName = "joyanta1978",
                    Email = "joyanta.uk@gmail.com"

                };

                await _userManager.CreateAsync(user, "Barisa!1978");
            }
            ...
            if (!_context.Trips.Any())
            {
                var usTrip = new Trip
                {
                    ...
                    Name = "US trip",
                    UserName = "joyanta1978", //ToDo add UserName
                    Stops = new List<Stop>()
                    {
